# Pyxam
Pyxam is a recreation of the R exam package functionality in python. After development details? head over to the [docs](https://rawgit.com/balancededge/pyxam/master/docs/build/0_index.html).
