\documentclass[12pt]{exam}
    ...
    % If this is not included figure urls will cause warnings
...
%>
                ...
                \begin{solution}
                    <%= pyxam.numerical(a + b) %>
                \end{solution}
            \titledquestion{12. Picking Parameters From a List}
...
%>
                ...
                \begin{solution}
                    <%= pyxam.numerical(a + b) %>
                \end{solution}
            \titledquestion{13. Calculated Question}
...
%>
                ...
                \end{solution}
                <%= pyxam.dataset(a, b) %>
            \titledquestion{14. Calculated Question Picked From List}
