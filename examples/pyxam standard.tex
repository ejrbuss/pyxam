...
\documentclass[12pt]{exam}
    ...
    % Standard definition for true/false questions
    \newcommand{\tf}[1][{}]{%
        \fillin[#1][0.25in]%
    }
    ...
    \begin{document}
        ...
        \textbf{Name:} % pyxam!student_name

        \textbf{Student Number:} % pyxam!student_number
        ...
        \begin{questions}
            ...
            \titledquestion{8. Verbatim Python Code}
...
if localtime().tm_hour >=dark[localtime().tm_mon] or localtime().tm_hour < light[localtime().tm_mon]:
    ...
    answer = 'No'
            ...
            \titledquestion{9 Using Python to Randomly Generate a Question}
...
b = random.randint(0, 32)
            ...
            \titledquestion{10 Other Pyxam commands}
            ...
            \titledquestion{11 Question With a Figure}
...
plt.show()
            ...
            % pyxam!import 1 examples/questions/import\ example.tex
